...
declare function onForgeEvent(name: "org.thinkingstudio.obsidianui.forge.event.ResolutionChangeCallbackEvent", handler: (event: Internal.ResolutionChangeCallbackEvent) => void);
...
declare function onForgeEvent(name: "org.thinkingstudio.obsidianui.forge.event.OpenScreenCallbackEvent$Post", handler: (event: Internal.OpenScreenCallbackEvent$Post) => void);
...
declare function onForgeEvent(name: "mekanism.common.content.network.BoxedChemicalNetwork$ChemicalTransferEvent", handler: (event: Internal.BoxedChemicalNetwork$ChemicalTransferEvent) => void);
...
declare function onForgeEvent(name: "org.thinkingstudio.obsidianui.forge.event.OpenScreenCallbackEvent$Pre", handler: (event: Internal.OpenScreenCallbackEvent$Pre) => void);
